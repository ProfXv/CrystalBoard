...
ColorPickerWidget::ColorPickerWidget(QWidget *parent) : QWidget(parent), currentColor(255, 255, 255, 128)
{
    ...
    const QString helpText =
        ...
        "</div>"
        "<div align='center'>"
        "<table style='width:100%; margin-top: 15px; border-style: solid; border-width: 2px 0; border-color: white;'>"
        "<thead>"
        "<tr><th style='padding: 10px; text-align: center; border-bottom: 2px solid white;'>Left Button</th><th style='padding: 10px; text-align: center; border-bottom: 2px solid white;'>Middle Button</th><th style='padding: 10px; text-align: center; border-bottom: 2px solid white;'>Right Button</th></tr>"
        "</thead>"
        "<tbody>"
